...
class MenusService:
    ...
    def createMenu(self, menu_name, menu_description, menu_price, menu_photo, menu_status, restaurant_id, category):

        query = "INSERT INTO menu (menu_id, menu_name, menu_description, menu_price, menu_photo, menu_status, restaurant_id, category) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
        try:
            ...
            with Database() as cursor:
                menu_id = str(uuid.uuid4())
                data = (menu_id, menu_name, menu_description, menu_price, menu_photo, menu_status, restaurant_id, category)
                cursor.execute(query, data)
                return True
